...
export default function Speakers() {
    ...
    const speakerItem = (speaker) => {
        const positionArray = speaker.position_1.split('!$')
    ...
    return (
        <section className={`${s.speakers} container`} id='speakers'>
            ...
            <h3 className={s.speaker__title}> Strateji HR trendləri paneli</h3>
            ...
            <h3 className={s.speaker__title}> CEO paneli</h3>
            ...
            <h3 className={s.speaker__title}> HR və Transformasiya paneli</h3>
