    ...
    return (
        <div className={s.intro}>
            <div className={s.intro__content}>
                ...
                <h6><span>Strategic</span> <span>Hr</span> <span>forum</span> </h6>

                <div className={s.deadline}>
                        <span className={s.day}>Gün</span>
                        <span className={s.hour}>Saat</span>
                        <span className={s.min}>Dəqiqə</span>
                        <span className={s.sec}>Saniyə</span>
                    <p>
                        <Countdown date={new Date('2024-10-04T00:00:00').getTime()} />
                    </p>
                    </div>
                ...
                <div className={s.date}>
                    <p>Baku Mariott <br /> Hotel Boulevard</p>
