        ...
        <section className={`${s.program} container`} id='program'>
            ...
            <div className={s.contact__us} id='contact'>
                ...
                <div className={s.right__content}>
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2620.0141151592807!2d49.88105037544023!3d40.37487837144636!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40307d1f85d9b639%3A0xeda9cb854d1b6add!2sBaku%20Marriott%20Hotel%20Boulevard!5e1!3m2!1sru!2saz!4v1726243374130!5m2!1sru!2saz" width="100%" height="100%" style={{ border: 0 }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </section>
    )
